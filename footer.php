<footer>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 site-overview mb-5">
                    <a href="/"><img src="<?php echo get_template_directory_uri().'/assets/img/icon.png'; ?>" alt="site-logo" height="40" /><span class="text-grad">ArisTech</span> </a>
                ...
                <div class="col-lg-2 services-menu mb-5">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="#">Virtual Assiatant</a></li>
    ...
    <div class="footer-copyright">
        <p>
            &copy; All Rights Reserved by <a href="/">ArisTech</a> 2019 | Made with &hearts; by
