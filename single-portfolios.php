...
<?php
        ...
        <div class="portfolio-single__header">
            <div class="container d-flex justify-content-between align-items-center">
                <div class="portfolio-single__meta">
                    ...
                    <a class="btn btn-main" href="<?php echo site_url('/#services');?>">View Sevices<i class="ic"
        ...
        <div class="portfolio-single__contact text-center mb-5">
                <a class="btn btn-main" href="<?php echo site_url('/contact');?>">Contact Now <i class="ic"
                    data-feather="arrow-right"></i></a>
        </div>
