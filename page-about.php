            ...
            <div class="row">
                ...
                <div class="col-lg-4 text-center site-infobox align-self-baseline">
                    ...
                    <ul class="footer-social">
                        <li><a target="_blank" href="#"><i data-feather="facebook"></i></a></li>
                        <li><a target="_blank" href="#"> <i data-feather="linkedin"></i></a></li>
                        <li><a target="_blank" href="#"> <i data-feather="twitter"></i></a></li>
